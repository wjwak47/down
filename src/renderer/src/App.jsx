            ...
            <div className="flex h-screen overflow-hidden bg-background-light dark:bg-background-dark">
                ...
                <main className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="flex-1 overflow-hidden flex flex-col">
                        ...
                        {/* Video Downloader (Assets) */}
                        {currentPage === 'video-downloader' && <VideoDownloader pendingUrl={pendingUrl} onClearPendingUrl={() => setPendingUrl('')} />}
                        ...
                        {/* File Compressor */}
                        {currentPage === 'file-compressor' && <FileCompressor pendingFiles={pendingFiles} onClearPending={() => setPendingFiles([])} />}
